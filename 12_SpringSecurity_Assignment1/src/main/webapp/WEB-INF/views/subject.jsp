    ...
    <%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
        <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
            ...
            <body>
                ...
                <table class="beta">
                    <c:choose>
                        <c:when test="${role=='ROLE_PRINCIPAL'}">
                            <tr>
                                <td>
                                        ...
                                        <table>
                                            ...
                                            <c:forEach items="${subjects}" var="subject">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="button" value="Delete" onclick="deleteSubject('${subject.subjectId}')" />
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </table>
                                        ...
                                        <table>
                                            ...
                                            <c:forEach items="${books}" var="book">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="button" value="Delete" onclick="deleteBook('${book.bookId}')" />
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </table>
