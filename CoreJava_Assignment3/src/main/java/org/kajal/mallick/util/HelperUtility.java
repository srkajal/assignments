...
public class HelperUtility {
    public static void printResult(Collection<Subject> subjects, boolean printBooks) {
        printChar("*");
        ...
        for (Subject subject : subjects) {
            ...
            if (subject.getReferences() != null && printBooks) {
    ...
    public static void printBook(Collection<Book> books) {
