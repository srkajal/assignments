...
public class SubjectControllerTest {
    ...
    public void subjectForm() {
        when(readWriteOperation.findAllBooks()).thenReturn(books);
        when(readWriteOperation.findAllSubjects()).thenReturn(subjects);
        when(subject.getSubjectId()).thenReturn(1l);
        when(subject.getSubtitle()).thenReturn("title");
        assertEquals("subject", subjectController.subjectForm(model));
    }
    ...
    @Test
    public void formBackingSearchBook() {
        assertEquals(null, subjectController.formBackingSearchBook().getTitle());
    }
}