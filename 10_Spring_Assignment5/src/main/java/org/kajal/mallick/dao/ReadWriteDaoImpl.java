...
public class ReadWriteDaoImpl implements ReadWriteDao {
    ...
    public List<Subject> findSubjectsByTitle(String SubjectTitle) {
        ...
        try {
            subjects = subjectRepositories.findBySubtitle(SubjectTitle);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public List<Subject> findSubjectsByDuration(int duration) {

        List<Subject> subjects = null;

        try {
            subjects = subjectRepositories.findByDurationInHours(duration);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
