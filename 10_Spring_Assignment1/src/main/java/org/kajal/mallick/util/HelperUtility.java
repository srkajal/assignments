...
public class HelperUtility {
    public void printResult(List<Subject> subjects) {
        printChar("*");
    ...
    public void printChar(String ch) {
        System.out.print("|");
        for (int i = 0; i < 31; i++) {
            System.out.print(ch);
        }
    ...
    public void printHeader(String StringToPrint) {
        System.out.print("|");
    ...
    public void printKeyAndValue(String key, Object value) {
        System.out.print("| ");
    ...
    public void printBook(Set<Book> books) {
